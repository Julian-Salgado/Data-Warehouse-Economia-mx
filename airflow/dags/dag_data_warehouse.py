...
from airflow.providers.http.sensors.http import HttpSensor  # noqa: F401
...
def validar_calidad():
    ...
    if resultado.returncode != 0:
        ...
        raise Exception("Validacion de calidad falló")
...
with DAG(
    ...
    schedule="0 6 * * *", #todos los dias a las 6 AM
    catchup=False,
    ...
    t_verificar >> t_cargar >> t_validar >> t_dbt_run >> t_dbt_test >> t_exito
